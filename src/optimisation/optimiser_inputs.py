...
REQUIRED_OPTIMISER_COLUMNS = [
    ...
    "regional_alpha_score",
    "regional_alpha_composite",
    "regional_alpha_selection_utility",
    "regional_benchmark_expected_return_12m",
    "benchmark_relative_expected_return_12m",
    "cost_adjusted_benchmark_relative_return_12m",
    "estimated_entry_trade_weight",
    "estimated_entry_cost_bps",
    "estimated_entry_cost_fraction",
    "regional_alpha_retention_bonus",
    "scorecard_score",
    "portfolio_fit_score",
